    ...
    <section id="gallery" className="px-4 py-24">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12 flex items-center gap-4">
          ...
          <h2 className="text-3xl font-bold">My World</h2>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <p className="text-lg leading-relaxed text-muted-foreground">
              Life beyond the code — a curated visual diary of the places I&apos;ve been, the events
              I&apos;ve attended, and the moments worth remembering.
            </p>
            <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            <Link
              href="/gallery"
              className="glass-card group inline-flex items-center gap-3 rounded-2xl px-6 py-4 transition-all hover:border-primary/50"
            >
